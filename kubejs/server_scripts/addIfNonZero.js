...
ItemEvents.rightClicked(event => {
    ...
    let 莓酿离歌总值 = parseFloat(持久化数据.getFloat("莓酿离歌"))
    let 磐石之根总值 = parseFloat(持久化数据.getFloat("磐石之根"))
    let 风之轻语总值 = parseFloat(持久化数据.getFloat("风之轻语"))
    let 星火熔炉总值 = parseFloat(持久化数据.getFloat("星火熔炉"))
    let 森灵秘语总值 = parseFloat(持久化数据.getFloat("森灵秘语"))
    let 匠魂飨宴总值 = parseFloat(持久化数据.getFloat("匠魂飨宴"))
    let 虚空遗尘总值 = parseFloat(持久化数据.getFloat("虚空遗尘"))
    let 果香织梦总值 = parseFloat(持久化数据.getFloat("果香织梦"))
    let 餮魇归一总值 = parseFloat(持久化数据.getFloat("餮魇归一"))
    let 腐嗅噬心总值 = parseFloat(持久化数据.getFloat("腐嗅噬心"))
    let 潜渊共鸣总值 = parseFloat(持久化数据.getFloat("潜渊共鸣"))
    let 腌痕铠胄总值 = parseFloat(持久化数据.getFloat("腌痕铠胄"))
